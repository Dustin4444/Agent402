...
//
// How it stays safe: the catalog has several legitimate counts (total ~1,419,
...
// each count is a distinct comma-grouped value, replacing e.g. "1,419" → "1,419"
...
try {
  ...
  const want = total.toLocaleString("en-US"); // "1,419"
