...
//
// How it stays safe: the catalog has several legitimate counts (total ~1,428,
...
// each count is a distinct comma-grouped value, replacing e.g. "1,428" → "1,428"
...
try {
  ...
  const want = total.toLocaleString("en-US"); // "1,428"
