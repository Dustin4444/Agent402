...
//
// How it stays safe: the catalog has several legitimate counts (total ~1,417,
...
// each count is a distinct comma-grouped value, replacing e.g. "1,417" → "1,417"
...
try {
  ...
  const want = total.toLocaleString("en-US"); // "1,417"
