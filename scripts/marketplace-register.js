...
async function main() {
  ...
  const publish = { is_published: true, tagline: "1,413 web tools agents pay for per call — search, browser, finance, EDGAR, memory. No signup.", tags: ["tools", "web-search", "browser", "memory", "finance", "edgar", "x402", "agents"] };
