...
**1,415 endpoints + 100 multi-tool [[Skill Packs|Skill-Packs]].** All deterministic — **no LLM in the serving path**: same input, same output, full input/output schemas. Discover them machine-readably (don't hardcode this page):
