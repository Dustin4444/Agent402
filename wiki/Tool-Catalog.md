...
| `stock-quote`, `stock-history` | $0.001–$0.005 | **finance-kit**: end-of-day US equity quote and daily OHLCV bars, from a licensed four-venue consolidation (Databento DBEQ.BASIC). Prices track the wider market; volume counts those four venues only and is returned as `venueVolume`, never as a total. US equities only |
