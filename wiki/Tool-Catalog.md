...
| `stock-quote`, `stock-dividends`, `stock-history` | $0.001–$0.005 | **finance-kit**: price, dividend history, OHLC history, and the upcoming/recent earnings calendar for any ticker. Fresh, no API key required |
