...
> **The catalog is hard-capped at 500 (400 tools + 100 skill packs), CI-enforced** (`scripts/sync-count.js --check`). For a new tool to enter, one must leave — every entry earns its slot.
