...
- **For people (card, no wallet):** [`/reports`](https://agent402.tools/reports) one-off reports · [`/monitors`](https://agent402.tools/monitors) $5/month watches · [`/credits`](https://agent402.tools/credits) prepaid credits for every tool - see [[Reports, Monitors and Credits|Reports-and-Monitors]]
