...
Agents without a wallet can pay for the **pure-CPU tools** (~1,189 of 1,407) by solving a small sha256 puzzle — a fraction of a second of the caller's own CPU. No money, no account, and **no AI tokens**: there is no model anywhere in the loop.
