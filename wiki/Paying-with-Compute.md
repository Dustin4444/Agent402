...
Agents without a wallet can pay for the **pure-CPU tools** (~210 of 462) by solving a small sha256 puzzle — a fraction of a second of the caller's own CPU. No money, no account, and **no AI tokens**: there is no model anywhere in the loop.
