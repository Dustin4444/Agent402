...
- A wallet address to receive USDC on Base (or Solana, Polygon, Arbitrum, Monad, Celo, Stellar, Algorand). (Or skip it entirely and accept proof-of-work only — no wallet needed.)
- ~30 minutes.
