...
- Use the name in module/import paths where renaming would break compatibility
  (e.g. `agent402-mcp` as a dependency identifier).

## You may not, without written permission

- Name a fork, derivative, or competing service "Agent402" or anything
  confusingly similar (e.g. "Agent402 Pro", "Agent402x", "Agent-402"),
  including in domain names, app-store listings, MCP directory entries,
  x402 discovery manifests, or social-media handles.
- Use the logo, or present a modified version of the software in a way that
  implies it is the hosted service at agent402.tools or is endorsed by
  Havok Holdings LLC.
- Register the marks (or confusingly similar ones) as trademarks, domains
