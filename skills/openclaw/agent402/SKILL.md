...
1,432 deterministic web tools an agent can call over plain HTTP, paid per call.
...
2. **No wallet at all**: solve a proof-of-work puzzle instead of paying. About
   1,000 of the 1,432 tools are pure-CPU and PoW-eligible; no money, no signup,
