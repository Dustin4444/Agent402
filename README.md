# Agent402.Tools — the open x402 index (Find · Route · Leaderboard) + 1,414 tools & 92 skill packs for AI agents
...
>
> Plus the whole **1,414-tool catalog** and **92 curated skill packs** (multi-tool
...
**Give your AI agent 1,414 ready-to-use web tools — plus 92 multi-tool skill packs — from one server. Browser
...
**3. Clone and host the whole thing** (all 1,414 tools as an HTTP API + MCP, free mode, no payments):
...
## What's in the catalog (1,414 tools)
...
- **Everything is tested** — CI calls all 1,414 tools with their own documented
...
a ready-to-run **x402 server** that already speaks the protocol and ships 1,414
