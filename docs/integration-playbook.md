...
3. Provide:
   ...
   - Description: "1,425 deterministic pay-per-call tools for AI agents (search, finance, EDGAR, crypto, PDFs, OCR, and more). x402 native."
   ...
   - Tool count: 1,425 + 92 skill packs
...
4. Provide:
   ...
   - Role: x402 seller (1,425 tool endpoints, 1,500+ settlements)
...
AgentCore ships a managed Bazaar MCP server — Agent402's 1,425 endpoints are already
