...
3. Provide:
   ...
   - Description: "1,414 deterministic pay-per-call tools for AI agents (search, finance, EDGAR, crypto, PDFs, OCR, and more). x402 native."
   ...
   - Tool count: 1,414 + 92 skill packs
...
4. Provide:
   ...
   - Role: x402 seller (1,414 tool endpoints, 1,500+ settlements)
...
AgentCore ships a managed Bazaar MCP server — Agent402's 1,414 endpoints are already
