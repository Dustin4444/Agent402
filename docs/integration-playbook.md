...
3. Provide:
   ...
   - Description: "462 deterministic pay-per-call tools for AI agents (search, finance, EDGAR, crypto, PDFs, OCR, and more). x402 native."
...
4. Provide:
   ...
   - Role: x402 seller (462 tool endpoints, 1,500+ settlements)
...
AgentCore ships a managed Bazaar MCP server — Agent402's 462 endpoints are already
