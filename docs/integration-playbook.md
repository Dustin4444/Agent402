...
3. Provide:
   ...
   - Description: "501 deterministic pay-per-call tools for AI agents (search, finance, EDGAR, crypto, PDFs, OCR, and more). x402 native."
   ...
   - Tool count: 501 + 100 skill packs
...
4. Provide:
   ...
   - Role: x402 seller (501 tool endpoints, 1,500+ settlements)
...
AgentCore ships a managed Bazaar MCP server — Agent402's 501 endpoints are already
