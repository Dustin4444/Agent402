...
3. Provide:
   ...
   - Description: "1,417 deterministic pay-per-call tools for AI agents (search, finance, EDGAR, crypto, PDFs, OCR, and more). x402 native."
   ...
   - Tool count: 1,417 + 92 skill packs
...
4. Provide:
   ...
   - Role: x402 seller (1,417 tool endpoints, 1,500+ settlements)
...
AgentCore ships a managed Bazaar MCP server — Agent402's 1,417 endpoints are already
