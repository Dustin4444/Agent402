...
export function mppMarketPage(baseUrl, snapshot, leaderboard = null) {
  ...
  <div style="padding:26px;border:1.5px solid var(--ink);background:var(--card);margin-top:48px;">
    ...
    <div style="display:flex;flex-direction:column;">${[
      "Discovery: the public mpp.dev services registry, plus anyone who self-registers at POST /api/mpp-index/register.",
      "Every listed origin gets a real, unpaid request to one of its actual advertised endpoints - a registry claim alone never counts.",
