...
const ROLES = [
  ...
  ["PROVE", "On-chain transparency", "Live revenue by rail and wire, the seller leaderboard, uptime measured from outside, refunds ledgered. Numbers you can check, not claims.", "/revenue", "see the numbers"],
];
