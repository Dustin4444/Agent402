...
const FAQS = [
  ...
  ["How do I sell an API over x402?", "Put an x402 paywall in front of your endpoint so unpaid requests answer 402 with your price and payment terms, then register the origin with a public index so buyers and routers can find you. On Agent402 that is POST /api/index/register: listing is free, there is no signup, and nothing is deducted from your price, though the router does charge buyers a flat fee when they ask it to execute a call on their behalf."],
  ...
  <div style="max-width:1180px;margin:0 auto;padding:52px 30px 44px;">
    ...
    <div class="wx-2col" style="display:grid;grid-template-columns:1.1fr .9fr;gap:50px;align-items:start;">
      <div>
        ...
        <p style="font-size:16px;line-height:1.6;color:var(--muted);margin:0;">No subscription, no checkout page, no account. That matters because an AI agent cannot open one: paying per call is the only purchase an autonomous program can actually make on its own.</p>
      </div>
