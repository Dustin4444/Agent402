...
export function contactPage(baseUrl) {
  ...
  const description = "Get in touch with the Agent402 team. Email hello@agent402.tools, security@agent402.tools for vulnerabilities, or reach out on GitHub and X.";
...
<div class="ct-wrap">
  ...
  <p style="font-size:15px;color:var(--muted);max-width:60ch;margin:0 0 18px;">Questions, integrations, partnerships, press or investment: pick the channel below. Security reports go to <a href="/security">/security</a>; abuse, copyright and legal requests to legal@agent402.tools (see <a href="/terms">/terms</a>). The company page is at <a href="/company">/company</a>.</p>
