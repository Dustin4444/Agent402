...
export function ledgerDocsPage(baseUrl) {
  ...
  const description = `Add 1,414 deterministic tools to your agent in about a minute. No signup, no API key — start free with proof-of-work, settle ${RAILS_PAREN} when you scale.`;
  ...
  <div class="ml-docs-grid" style="max-width:1180px;margin:0 auto;padding:50px 30px 64px;display:grid;grid-template-columns:220px 1fr;gap:44px;">
    ...
    <main>
      ...
      <p style="font-size:17px;line-height:1.55;color:var(--muted);max-width:620px;margin:0 0 30px;">Add 1,414 deterministic tools to your agent in about a minute. No signup, no API key &mdash; start free with proof-of-work, settle ${RAILS_PAREN} when you scale.</p>
