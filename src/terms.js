...
<ul>
  ...
  <li>No account or signup. Access is by paying per call (USDC/USDG via the x402 protocol or MPP), by card (Stripe Checkout, for reports, monitors and credits), or, on the pure-CPU tools, by solving a proof-of-work challenge. The hosted MCP connector exposes the pure-CPU tools free, rate-limited.</li>
