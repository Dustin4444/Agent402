...
export const TOKEN_RISK_TIERS = {
  "token-risk": { price: "$5", maxUpstreamUsd: 1.5, holders: 20, scan: false, web: 0, synthMaxTokens: 3500, words: "~1,200" },
  "token-risk-pro": { price: "$12", maxUpstreamUsd: 4, holders: 50, scan: true, web: 1, synthMaxTokens: 5000, words: "~1,900" },
};
