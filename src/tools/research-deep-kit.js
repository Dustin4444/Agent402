...
export const RESEARCH_TIERS = {
  "research": { price: "$3", maxUpstreamUsd: 1.2, subQ: 3, searches: 3, topK: 15, synth: M.synthPrem, synthMaxTokens: 5000, words: "~1,500" },
  "research-pro": { price: "$7", maxUpstreamUsd: 2.8, subQ: 6, searches: 8, topK: 30, synth: M.synthPrem, synthMaxTokens: 7000, words: "~2,200" },
  "research-max": { price: "$12", maxUpstreamUsd: 4.8, subQ: 12, searches: 12, topK: 40, synth: M.synthPrem, synthMaxTokens: 8000, words: "~2,800" },
  ...
  "market-brief": { price: "$7", maxUpstreamUsd: 2.8, subQ: 6, searches: 8, topK: 30, synth: M.synthPrem, synthMaxTokens: 7000, words: "~2,200",
