...
export const RESEARCH_TIERS = {
  "research": { price: "$0.35", maxUpstreamUsd: 0.30, subQ: 3, searches: 3, topK: 15, synth: M.synthPrem, synthMaxTokens: 5000, words: "~1,500" },
  "research-pro": { price: "$0.65", maxUpstreamUsd: 0.55, subQ: 6, searches: 8, topK: 30, synth: M.synthPrem, synthMaxTokens: 7000, words: "~2,200" },
  "research-max": { price: "$1.10", maxUpstreamUsd: 0.95, subQ: 12, searches: 12, topK: 40, synth: M.synthPrem, synthMaxTokens: 8000, words: "~2,800" },
  ...
  "market-brief": { price: "$0.35", maxUpstreamUsd: 0.30, subQ: 6, searches: 8, topK: 30, synth: M.synthPrem, synthMaxTokens: 7000, words: "~2,200",
