...
export const DOSSIER_TIERS = {
  "dossier": { price: "$9", maxUpstreamUsd: 3.6, filings: 3, insiderDays: 120, searches: 4, topWeb: 20, synthMaxTokens: 7000, words: "~2,400" },
  "dossier-max": { price: "$19", maxUpstreamUsd: 7.6, filings: 6, insiderDays: 365, searches: 8, topWeb: 32, synthMaxTokens: 8000, words: "~2,800" },
};
