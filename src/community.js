...
export function communityPage(baseUrl) {
  ...
  const pageDesc = "Join the Agent402 community: contribute tool kits, write guides, and build autonomous agents with 1,416 deterministic web tools on the x402 protocol.";
