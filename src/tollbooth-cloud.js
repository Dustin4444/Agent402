...
<div class="flywheel">
  ...
  <p>Any wallet that runs a verified Tollbooth install earns <b>1.5× bonus Agent402.tools credit</b> per dollar of settled USDC its install charges. Spend it on the 1,431 paid tools in the <a href="${esc(baseUrl)}/tools">catalog</a> (browser, search, PDFs, images, live data, identifiers) or against the <a href="${esc(baseUrl)}/index">Smart Order Router</a>. Tollbooth installs feed Agent402 demand; Agent402 buyers feed Tollbooth supply.</p>
</div>
