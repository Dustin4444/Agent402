  ...
  <div style="max-width:1180px;margin:0 auto;padding:84px 30px 56px;position:relative;">
    <div class="hm-hero">
      <div class="ml-stagger" style="display:flex;flex-direction:column;gap:26px;">
        <div class="ml-hero-eyebrow" style="font-family:var(--font-mono);font-size:12px;letter-spacing:.18em;text-transform:uppercase;color:var(--faint);">Wallet or card. Same key, same receipts.</div>
