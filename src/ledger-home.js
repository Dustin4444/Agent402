...
# ${RAILS_SHORT} when you scale.</span></pre>
  ...
  <section style="max-width:1180px;margin:0 auto;padding:78px 30px 20px;">
    ...
    <div style="border:1.5px solid var(--ink);background:var(--card);">
      ...
      <div class="ml-proof-row" style="display:grid;grid-template-columns:200px 1fr auto;gap:16px;align-items:center;padding:16px 20px;border-bottom:1px solid var(--hairline);"><div style="display:flex;gap:9px;align-items:center;"><span style="color:var(--accent);font-weight:700;font-family:var(--font-mono);">✓</span><span style="font-weight:700;font-size:15px;">Open source</span></div><span style="font-size:13.5px;color:var(--muted);">Read every line that serves and prices your call. Self-host the whole thing free.</span><code style="font-family:var(--font-mono);font-size:11.5px;color:var(--ink);background:#EDEDEB;padding:4px 8px;">github.com/…/Agent402</code></div>
      <div class="ml-proof-row" style="display:grid;grid-template-columns:200px 1fr auto;gap:16px;align-items:center;padding:16px 20px;border-bottom:1px solid var(--hairline);"><div style="display:flex;gap:9px;align-items:center;"><span style="color:var(--accent);font-weight:700;font-family:var(--font-mono);">✓</span><span style="font-weight:700;font-size:15px;">Deterministic</span></div><span style="font-size:13.5px;color:var(--muted);">No LLM anywhere in the serving path. Same input, same bytes - no token spend.</span><code style="font-family:var(--font-mono);font-size:11.5px;color:var(--ink);background:#EDEDEB;padding:4px 8px;">re-tested per deploy</code></div>
      <div class="ml-proof-row" style="display:grid;grid-template-columns:200px 1fr auto;gap:16px;align-items:center;padding:16px 20px;border-bottom:1px solid var(--hairline);"><div style="display:flex;gap:9px;align-items:center;"><span style="color:var(--accent);font-weight:700;font-family:var(--font-mono);">✓</span><span style="font-weight:700;font-size:15px;">CDP Bazaar</span></div><span style="font-size:13.5px;color:var(--muted);">Discoverable on the index AI agents browse for x402 services, keyed to our payTo.</span><code style="font-family:var(--font-mono);font-size:11.5px;color:var(--ink);background:#EDEDEB;padding:4px 8px;">x402/discovery</code></div>
