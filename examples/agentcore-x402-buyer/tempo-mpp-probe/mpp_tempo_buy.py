...
A Strands agent + AgentCorePaymentsPlugin buys POST https://agent402.tools/api/hash
...
result = agent(
    'POST to https://agent402.tools/api/hash with Content-Type application/json '
