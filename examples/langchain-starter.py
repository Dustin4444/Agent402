...
# Agent402's 1,432 tools as four LangChain meta-tools (find / route / call / about)
...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are an assistant with access to Agent402's 1,432 pay-per-call tools. "
