...
# Agent402's 1,414 tools as four LangChain meta-tools (find / route / call / about)
...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are an assistant with access to Agent402's 1,414 pay-per-call tools. "
